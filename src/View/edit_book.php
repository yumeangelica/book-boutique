...
<body>
  <div class="main-content">
    ...
    <form action="/books/update/<?= $book['id'] ?>" method="post" class="form-section">
      <div class="form-floating">
        <input type="text" class="form-control" id="title" name="title" placeholder="Book Title" value="<?= htmlspecialchars($book['title']) ?>"
          required>
        <label for="title"><i class="fas fa-book me-1"></i>Title</label>
      </div>

      <div class="form-floating">
        <input type="text" class="form-control" id="author" name="author" placeholder="Author Name" value="<?= htmlspecialchars($book['author']) ?>"
          required>
      ...
      <div class="form-floating">
        <input type="text" class="form-control" id="isbn" name="isbn" placeholder="ISBN Number"
          value="<?= $book['isbn'] ? htmlspecialchars($book['isbn']) : '' ?>" pattern="[\d\-\s\x]*" title="Enter ISBN-10 or ISBN-13 format">
      ...
      <div class="form-floating">
        <input type="number" class="form-control" id="published_year" name="published_year" placeholder="Publication Year"
          value="<?= $book['published_year'] ? htmlspecialchars($book['published_year']) : '' ?>" min="1000" max="<?= date('Y') ?>">
